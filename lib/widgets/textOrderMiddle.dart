...
class TextOrderMiddle extends StatefulWidget {
  @override
  _TextOrderMiddleState createState() => _TextOrderMiddleState();
}

class _TextOrderMiddleState extends State<TextOrderMiddle> {
